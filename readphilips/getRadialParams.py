...
# =============================================================================
    if radial_traj == True:
        ...
        # Define start and end points of gradient ramp and sampling
            int_ratio_1 = int(np.ceil(FILTER_TAPS * smoother - delay)) ##RH I added np.ceil because it was producing 9 instead of 10
            ...
            if smoother > 0:
                ...
                filt = np.exp(-np.arange(int(np.ceil(FILTER_TAPS * smoother))
                                + 1) / smoother) ##RH I added 1 because flit length should be 12 (per matlab code)
            ...
            ##RH two problems with this code: cumtrapz ≠ cumsum and Indexing offsets are different in matlab vs python
